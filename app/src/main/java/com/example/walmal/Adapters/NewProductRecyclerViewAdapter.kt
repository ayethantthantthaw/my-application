...
//class NewProductRecyclerViewAdapter(private var list: List<Posts>, private var context: Context?):
//    RecyclerView.Adapter<NewProductRecyclerViewAdapter.Myholder>(){
//    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): Myholder {
//        val view= LayoutInflater.from(p0.context).inflate(R.layout.list_item_new_product,p0,false)
